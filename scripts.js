...
// //первый
// function fib(n) {
//   let arr10 = new Array(n); //Заполняет все места в массиве значением 0, создавая новый массив размером 'n'
//   arr10.fill(0); //Этот метод заменяет все элементы в массиве значением, которым вы хотите заполнить массив, и возвращает измененный массив
//   arr10[0] = 0; //Начальное значение для 1-го элемента
//   arr10[1] = 1; //Начальное значение для 2-го элемента
//   for (let i = 2; i < n; i++) {
//     arr10[i] = arr10[i - 1] + arr10[i - 2]; // основная формула Фибоначчи
//   }
//   return arr10;
// }
// console.log(fib(17));
...
//   const arr = []; // создаем новый массив
//   for (let i = 0; i < N; i++) {
//     if (i === 0 || i === 1) arr[i] = 1;
//     else arr[i] = arr[i - 1] + arr[i - 2]; // основная формула Фибоначчи
//   }
//   return arr;
// }
